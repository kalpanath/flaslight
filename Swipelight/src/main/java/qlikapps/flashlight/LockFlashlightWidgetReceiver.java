...
public class LockFlashlightWidgetReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        appWidgetManager.updateAppWidget(new ComponentName(context, LockScreenWidgetProvider.class),
                views);
